...
<script>
import CrontabMin from "./components/CrontabMin";
import CrontabHour from "./components/CrontabHour";
import CrontabDay from "./components/CrontabDay";
import CrontabMouth from "./components/CrontabMouth";
import CrontabWeek from "./components/CrontabWeek";
import CrontabResult from "./components/CrontabResult";

export default {
    data() {
        return {
            tabTitles: ["分钟", "小时", "日", "月", "周"],
            tabActive: 0,
            myindex: 0,
            contabValueObj: {
                min: "*",
